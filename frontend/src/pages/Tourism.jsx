    ...
    return (
        <div className="min-h-screen bg-[#fcf9f2]">
            ...
            <div className="pb-32 px-6">
                <div className="max-w-6xl mx-auto bg-white rounded-[4rem] p-12 md:p-24 shadow-sm border border-gray-50 flex flex-col items-center text-center">
                    <div className="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center mb-8 rotate-3">
                    ...
                    <h2 className="text-4xl md:text-5xl font-black text-[#1e1964] uppercase tracking-tighter mb-8">Authentic Kharnak Living</h2>
                    <p className="text-gray-500 text-lg font-medium max-w-3xl mb-12 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
                        <div className="p-10 bg-[#fcf9f2] rounded-[3rem] text-left border border-gray-100 hover:border-black transition-all group">
                            <h3 className="font-black text-2xl text-[#1e1964] mb-4 uppercase tracking-tighter">Homestays</h3>
                            <p className="text-gray-500 font-medium mb-0 leading-relaxed italic">"Live like a local, not just a visitor."</p>
                        </div>
                        <div className="p-10 bg-[#fcf9f2] rounded-[3rem] text-left border border-gray-100 hover:border-black transition-all group">
                            <h3 className="font-black text-2xl text-[#1e1964] mb-4 uppercase tracking-tighter">Bespoke Treks</h3>
                            <p className="text-gray-500 font-medium mb-0 leading-relaxed italic">"Trace the ancient pathways of the shepherds."</p>
                        </div>
                    </div>
                </div>
            </div>
