...
const AddPublication = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(
                backendUrl + "/api/publication/add",
                formData,
                { headers: { token } }
            );
    ...
    return (
        <form onSubmit={onSubmitHandler} className="w-full">
            <div className="mb-10">
                <h1 className='text-4xl font-black text-gray-800 tracking-tighter uppercase mb-2'>Publication Hub</h1>
                <p className="text-gray-500 font-medium tracking-tight">Expand the Kharnak digital library with new works.</p>
            </div>
            ...
            <div className="w-full bg-white p-8 md:p-12 rounded-[3rem] shadow-sm border border-gray-50">
                <div className="flex flex-wrap gap-10 mb-10">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-purple-600 mb-4">PDF Document (Optional)</p>
                        <div className="flex flex-col gap-4">
                            ...
                            {file && <button type="button" onClick={() => setFile(false)} className="text-[10px] font-black uppercase tracking-widest text-red-500 hover:underline">Remove File</button>}
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                placeholder="Mountain deities among the nomadic community..."
                                required
                            />
                        </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2">URL / Link (YouTube or External)</p>
                            <input
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Glimpses of Northern India’s Vanishing Nomads..."
                            />
                        </div>
                    </div>
                </div>
